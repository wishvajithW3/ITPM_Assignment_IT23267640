Singlish to Sinhala Transliterator — Test Automation Suite
...
---
Test Case Summary
The test suite covers 50 negative test cases (Neg_0001 to Neg_0050) across the following input categories:
Category	Examples
...
--slow-mo-ms	0	Slow motion delay for all Playwright actions
